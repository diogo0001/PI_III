...
Serão utilizados neste projeto:
  ...
  - uC [stm32f103C8T6](https://www.curtocircuito.com.br/placa-arm-stm32-stm32f103c8t6.html) (Blue Pill): microcontrolador de 32 bits que é mais barato que um Arduino Uno e possui um PWM com resolução de 16 bits. É necessária uma boa resolução do PWM, para precisão do VCO, e consequentemente das notas. Na pasta Arduino está a simulação do tratamento do sinal PWM->VCO, que foi feita para testar a técnica utilizando o uC que havia disponivel para simulação.
